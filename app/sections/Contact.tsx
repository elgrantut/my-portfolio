...
export default function Contact() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        style={{ y }}
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-green-accent/5 rounded-full blur-3xl"
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          >
            ...
            >
              ...
              <p className="text-sm text-muted-foreground pl-[22px]">
